...
if __name__ == '__main__':
	...
	parser.add_argument('-u', dest='username', help='weibo username', default='150***01329')
	parser.add_argument('-p', dest='password', help='weibo password', default='***')
	parser.add_argument('-m', dest='max_page', help='max number of comment pages to crawl(number<int> larger than 0 or all)', default=5)
	parser.add_argument('-l', dest='link', help='weibo comment link', default='https://weibo.com/6475144268/Ii1rDEN6q?type=comment')
